...
- `createSovereignChannel()` --calls--> `test()`  [INFERRED]
  C:\WSGTA\universal-or-strategy\docs\arena_battles\round_24\sovereign-v24-protocol-development (7)\src\engine\SovereignChannel.ts → C:\WSGTA\universal-or-strategy\scripts\debug_extract.py
- `run_benchmark()` --calls--> `trace_forensic_run()`  [INFERRED]
  C:\WSGTA\universal-or-strategy\scripts\amal_harness_v26.py → C:\WSGTA\universal-or-strategy\scripts\langsmith_bridge.py
- `get_method_body()` --calls--> `End()`  [INFERRED]
  C:\WSGTA\universal-or-strategy\scripts\debug_extract.py → C:\WSGTA\universal-or-strategy\src\V12_002.Telemetry.cs
- `App()` --calls--> `useSimulation()`  [INFERRED]
  C:\WSGTA\universal-or-strategy\docs\audits\run_v5\audit_4\src\App.tsx → C:\WSGTA\universal-or-strategy\docs\audits\run_v5\audit_4\src\hooks\useSimulation.ts
- `autoDetectTopology()` --calls--> `addLog()`  [EXTRACTED]
  C:\WSGTA\universal-or-strategy\docs\arena_battles\round_24\low-latency-hardware-agnostic-pipeline\src\App.tsx → C:\WSGTA\universal-or-strategy\docs\audits\run_v10\v10-zip-4\src\App.tsx
...
Cohesion: 0.1
Nodes (3): AdaptiveStripingEngine, BenchmarkRunner, createSovereignChannel()
...
Cohesion: 0.67
Nodes (1): CacheConcurrency()

### Community 50 - "Community 50"
Cohesion: 0.67
Nodes (1): SafetyInvariants()

### Community 51 - "Community 51"
Cohesion: 1.0
Nodes (2): formatNumber(), TelemetryPanel()
...
- **Thin community `Community 63`** (2 nodes): `PerformanceOverview.tsx`, `PerformanceOverview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (2 nodes): `DiagramBox.tsx`, `DiagramBox()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `LatencySummary.tsx`, `pct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (2 nodes): `SectionBadge.tsx`, `SectionBadge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `AdversarialChallenge()`, `AdversarialChallenge.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `CacheStripeVisualizer.tsx`, `CacheStripeVisualizer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `CodeSubmission.tsx`, `CodeSubmission()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `FenceLessDiscipline.tsx`, `FenceLessDiscipline()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `PerformanceMetrics.tsx`, `Sparkline()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `usePerformanceSimulation.ts`, `usePerformanceSimulation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `CodeViewer.tsx`, `CodeViewer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `Explanation.tsx`, `Explanation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `TopologyVisualizer.tsx`, `TopologyVisualizer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `MetricsDashboard.tsx`, `animate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (2 nodes): `SafetyPanel.tsx`, `handleReverify()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (2 nodes): `StripingVisualizer.tsx`, `getModeLatency()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 79`** (2 nodes): `TopologyVisualization.tsx`, `TopologyVisualization()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (2 nodes): `SafetySection.tsx`, `SafetySection()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `Navigation.tsx`, `handleScroll()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (2 nodes): `StripingViz.tsx`, `renderDataFlow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (2 nodes): `LatencyTable.tsx`, `LatencyTable()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `Terminal.tsx`, `Terminal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `TelemetryChart.tsx`, `TelemetryChart()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `BenchmarkResults()`, `BenchmarkResults.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 87`** (2 nodes): `HardwareTopology.tsx`, `archIcon()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `LatencyMonitor.tsx`, `CustomTooltip()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `V24CodeDisplay.tsx`, `V24CodeDisplay()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 90`** (2 nodes): `AdaptiveStriping()`, `AdaptiveStriping.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 91`** (2 nodes): `BenchmarkPanel()`, `BenchmarkPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `CodeDisplay.tsx`, `CodeDisplay()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 93`** (2 nodes): `ProfileSelector.tsx`, `ProfileSelector()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 94`** (2 nodes): `TopologyView.tsx`, `TopologyView()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 95`** (2 nodes): `TopologyMap.tsx`, `cn()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (2 nodes): `NavHeader.tsx`, `NavHeader()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (2 nodes): `SafetyInvariants.tsx`, `generateSafetyChecks()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (2 nodes): `ScoreGauge.tsx`, `ScoreGauge()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 99`** (2 nodes): `ScoreMatrix.tsx`, `ScoreMatrix()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 100`** (2 nodes): `MemoryRemediation.tsx`, `MemoryRemediation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 101`** (2 nodes): `MetricsMonitor.tsx`, `render()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `canvas.worker.ts`, `render()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 103`** (2 nodes): `LatencyMonitor.tsx`, `LatencyMonitor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `LatencyGauge.tsx`, `getColor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `SlabMemory.tsx`, `useTicker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 106`** (2 nodes): `TimingGatePanel.tsx`, `pct()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 107`** (2 nodes): `Navigation.tsx`, `Navigation()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 108`** (2 nodes): `Slots.cs`, `R28`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 117`** (1 nodes): `SpscRing.Benchmarks.AssemblyInfo.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 118`** (1 nodes): `SpscRing.Benchmarks.AssemblyInfo.cs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
