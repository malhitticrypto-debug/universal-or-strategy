...
- **Audit Step:** On strategy start, verify the NinjaTrader Output window shows:
  `🛡 BMad HARDENED DEPLOYMENT PROTOCOL ACTIVE | Build: 960`
...
5.  **AI-Led Persistence:** The AI agent (Antigravity/Sonnet) is EXPLICITLY authorized and required to `git push` all verified repairs before closing a session. Do not leave uncommitted or unpushed changes in the local worktree.
